...
const requiredRole_1 = require("../../common/middleware/requiredRole");
exports.authRouter = (0, express_1.Router)();
exports.authRouter.post("/register", authController.register);
exports.authRouter.post("/login", authController.login);
exports.authRouter.get("/users", authenticate_1.authenticate, (0, requiredRole_1.requireRole)("ADMIN"), authController.getUsers);
